...
:comet: An example of using the CppComet server to create a chat. For more information about CppComet, see http://comet-server.org

:comet: [jsfiddle.net online demo](https://jsfiddle.net/o35kvmn2/5/)
